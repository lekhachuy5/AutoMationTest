...
public class selectListTest {
	...
	public void slJavaTest() {
		...
		WebElement listElements = driver.findElement(By.id("programming-languages"));

		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[1]"));
	...
	public void slCTest() {
		...
		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[2]"));
		slTest(listElements, elementName);
	}
	@Test(priority =3)
	public void slCSTest() {
		...
		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[3]"));
		slTest(listElements, elementName);
	}
	@Test(priority =4)
	public void slJavaScriptTest() {
		...
		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[4]"));
		slTest(listElements, elementName);
	}
	@Test(priority =5)
	public void slPythonTest() {
		...
		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[5]"));
		slTest(listElements, elementName);
	}
	@Test(priority =6)
	public void slPHPTest() {
		...
		WebElement elementName = driver.findElement(By.xpath("/html/body/form/div[3]/div[1]/select[1]/option[6]"));
		slTest(listElements, elementName);
	}
